...
Modified for integration with micromouse simulation framework.
Animation disabled by default - can be enabled for standalone testing.
...
# Disabled by default to avoid conflicts with main simulation
